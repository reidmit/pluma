...
_Best of 5 runs, wall-clock seconds (lower is better). Generated 2026-06-01 15:16:04 PDT._
...
|---|---|
| host | `Darwin arm64` |
| pluma | git `e167e5f` (release build) |
...
|---|---|--:|--:|--:|--:|--:|:--:|
| `fib` | naive recursion | 0.69 | 0.27 | 0.30 | 0.05 | 13.8x | ok |
| `mandelbrot` | float64 escape loop | 1.36 | 0.40 | 0.72 | 0.06 | 22.7x | ok |
| `primes` | integer trial division | 1.86 | 0.50 | 0.58 | 0.04 | 46.5x | ok |
| `sort` | sort + checksum | 1.80 | 0.03 | 0.07 | 0.05 | 60.0x | ok |
| `dict` | hash-map tally | 0.45 | 0.05 | 0.09 | 0.04 | 11.2x | ok |
| `string` | join / split / upcase | 1.45 | 0.02 | 0.07 | 0.03 | 72.5x | ok |
| `tree` | build + fold a tree | 1.60 | 3.38 | 0.98 | 0.11 | 14.5x | ok |
| `collections` | map / filter / fold | 0.78 | 0.12 | 0.16 | 0.14 | 6.5x | ok |
