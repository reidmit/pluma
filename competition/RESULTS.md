...
_Best of 2 runs, wall-clock seconds (lower is better). Generated 2026-06-01 19:54:03 PDT._
...
|---|---|
| host | `Darwin arm64` |
| pluma | git `f31454b` (release build) |
...
|---|---|--:|--:|--:|--:|--:|--:|--:|:--:|
| `fib` | naive recursion | 0.49 | 0.10 | 0.27 | 0.30 | 0.05 | 9.8x | 2.0x | ok |
| `mandelbrot` | float64 escape loop | 1.07 | 0.17 | 0.39 | 0.71 | 0.05 | 21.4x | 3.4x | ok |
| `primes` | integer trial division | 1.29 | 0.38 | 0.49 | 0.58 | 0.05 | 25.8x | 7.6x | ok |
| `sort` | sort + checksum | 1.62 | 0.29 | 0.04 | 0.07 | 0.06 | 40.5x | 7.2x | ok |
| `dict` | hash-map tally | 0.43 | >30s | 0.06 | 0.10 | 0.04 | 10.8x | — | ok |
| `string` | join / split / upcase | 1.28 | 1.69 | 0.03 | 0.07 | 0.04 | 42.7x | 56.3x | ok |
| `tree` | build + fold a tree | 1.24 | 0.51 | 3.35 | 0.96 | 0.12 | 10.3x | 4.2x | ok |
| `collections` | map / filter / fold | 0.69 | 0.22 | 0.12 | 0.15 | 0.14 | 5.8x | 1.8x | ok |
