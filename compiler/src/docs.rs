...
/// indented example block (dedented). Splitting happens once here so every
/// renderer (the website, Markdown, …) gets the same structure.
pub struct DocBlock {
	pub kind: &'static str,
	pub text: String,
}
...
pub fn to_pluma_source(modules: &[ModuleDoc]) -> String {
	...
	out.push_str("public alias doc-block {\n\tkind :: string\n\ttext :: string\n}\n\n");
	out.push_str(
