...
pub enum Token<'a> {
  ...
  KeywordAs { start: usize, end: usize },
  KeywordDef { start: usize, end: usize },
  KeywordLet { start: usize, end: usize },
  KeywordMatch { start: usize, end: usize },
  KeywordType { start: usize, end: usize },
  KeywordUse { start: usize, end: usize },
